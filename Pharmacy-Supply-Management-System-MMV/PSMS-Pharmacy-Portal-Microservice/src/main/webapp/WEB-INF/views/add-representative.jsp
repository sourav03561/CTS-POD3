...
<%@ include file="navbar.jsp"%>
	...
	<a type="button" class="btn btn-outline-dark"  href="/pharmacy/addPharmacy">Add Pharmacy</a>
	<a type="button" class="btn btn-outline-dark active" href="/pharmacy/addRepresentative">Add Representative</a>
	</div>
		<div class="container pt-5">
			<form:form action="/pharmacy/addRepresentative" method="POST" modelAttribute="medicalRepresentative">
				...
				<input type="submit" class="btn btn-success" value="Add Representative">
