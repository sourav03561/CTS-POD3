...
<%@ include file="navbar.jsp"%>
	...
	<a type="button" class="btn btn-outline-dark active"  href="/pharmacy/getSupplyRecords">Supply Records</a>
	<a type="button" class="btn btn-outline-dark"  href="/pharmacy/getDemandRecords">Demand Records</a>
	
		<div class="container pt-5">
			<h3>Medicine Supply Records</h3>
		</div>
		<div class="container pt-5">
			<table class="table">
				<thead>
				...
				<tbody>
					<c:forEach items="${prevSupply}" var="supply">
						<tr>
